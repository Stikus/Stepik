...
if ($_POST) //Условие будет выполнено, если произведен POST-запрос к скрипту.
{
	...
	else 
	{
	    ...
	    if (!empty($myrow["id"])) 
	    {
	    	exit ("Извините, введённый вами логин уже зарегистрирован. <a href='test1.php'>Введите другой логин</a>.");
	    }
		...
		if ($sql)
		{
			...
			exit ('<div align="center"><br/><br/><br/><h3> Вы успешно зарегистрированы на сайте! Заполните <a href="test1.php">форму входа</a> и войдите</h3></div>');
		}
